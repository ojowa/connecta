...
export class UsersController {
  ...
  updateMe(@Body('_userId') userId: string, @Body() body: any) {
    return this.usersService.updateMe(userId, body);
  }

  @Delete('me')
  @ApiOperation({ summary: 'Delete account' })
  deleteMe(@Body('_userId') userId: string, @Body() body: any) {
  ...
  getBlockedUsers(@Body('_userId') userId: string, @Query('page') page?: number, @Query('limit') limit?: number) {
  ...
  blockUser(@Body('_userId') userId: string, @Param('id') id: string, @Body() body: any) {
  ...
  reportUser(@Body('_userId') userId: string, @Param('id') id: string, @Body() body: any) {
