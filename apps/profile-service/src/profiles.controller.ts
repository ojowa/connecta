...
export class ProfilesController {
  ...
  getMyProfile(@Body('_userId') userId: string) {
    return this.profilesService.getProfile(userId);
  }

  @Put('me')
  @ApiOperation({ summary: 'Update profile' })
  updateProfile(@Body('_userId') userId: string, @Body() body: UpdateProfileDto) {
    return this.profilesService.updateProfile(userId, body);
  }

  @Get('me/photos')
  @ApiOperation({ summary: 'Get photos' })
  ...
  uploadPhoto(@Body('_userId') userId: string, @Body() body: UploadPhotoDto) {
  ...
  reorderPhotos(@Body('_userId') userId: string, @Body() body: ReorderPhotosDto) {
  ...
  setPrimary(@Body('_userId') userId: string, @Param('photoId') photoId: string) {
  ...
  getInterests() {
    return this.profilesService.getInterests();
  }
  ...
  getVerification(@Body('_userId') userId: string) {
