...
export class CallsWsProxy implements OnGatewayConnection, OnGatewayDisconnect {
  @WebSocketServer()
  server: Server;

  private logger = new Logger('CallsWsProxy');
  ...
  handleConnection(@ConnectedSocket() client: Socket) {
    ...
    const upstream = io(`${CALL_SERVICE}/calls`, {
