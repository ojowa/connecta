...
export class ModerationEventsHandler {
  ...
  @OnEvent(MODERATION_EVENTS.CONTENT_REPORTED)
  ...
  @OnEvent(MODERATION_EVENTS.CONTENT_REVIEWED)
  ...
  @OnEvent(MODERATION_EVENTS.USER_WARNED)
  ...
  @OnEvent(MODERATION_EVENTS.USER_SUSPENDED)
