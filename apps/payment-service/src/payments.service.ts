...
export class PaymentsService {
  ...
  async subscribe(userId: string, data: any) {
    ...
    this.natsClient.emit(PAYMENT_EVENTS.SUBSCRIPTION_ACTIVATED, {
      subscriptionId: sub.id,
      userId,
      planId: plan.id,
    ...
    this.natsClient.emit(PAYMENT_EVENTS.PAYMENT_SUCCESSFUL, {
  ...
  async cancelSubscription(userId: string, data: any) {
    ...
    this.natsClient.emit(PAYMENT_EVENTS.SUBSCRIPTION_CANCELLED, {
      subscriptionId: sub.id,
      userId,
      planId: sub.planId,
    });
