export const ENDPOINTS = {
  AUTH: {
    ...
    DELETE_DEVICE: (deviceId: string) => `/auth/devices/${deviceId}`,
  },
  USERS: {
    ME: '/users/me',
  ...
  CHAT: {
    ...
    REACT: (conversationId: string, messageId: string) =>
    ...
    READ_RECEIPT: (conversationId: string, messageId: string) =>
