        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          {existingAppeal.decision && (
            <View
              style={[
                styles.statusCard,
                existingAppeal.decision === 'approved' ? styles.approvedCard : styles.rejectedCard,
              ]}
            >
              ...
              <Text
                style={[
                  styles.statusValue,
                  existingAppeal.decision === 'approved'
                    ? styles.approvedText
                    : styles.rejectedText,
                ]}
              >
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Your account has been suspended or banned. If you believe this was a mistake, you can
        ...
        {APPEAL_REASONS.map((r) => (
          <View key={r} style={styles.radioRow}>
            ...
            <Text style={styles.radioLabel} onPress={() => setReason(r)}>
              {r}
            </Text>
          </View>
        ))}
