            ...
            <TouchableOpacity
              ...
              style={[
                styles.videoButton,
                {
                  ...
                  borderRadius: videoButtonSize / 2,
                },
                btn.isActive && styles.videoButtonActive,
              ]}
              onPress={btn.onPress}
              activeOpacity={0.8}
              accessible
          ...
          {endCallButton && (
            <TouchableOpacity
              style={[
                styles.videoEndCall,
                {
                  width: videoEndCallSize,
                  height: videoEndCallSize,
                  borderRadius: videoEndCallSize / 2,
                },
              ]}
              onPress={endCallButton.onPress}
              activeOpacity={0.8}
              accessible
              accessibilityRole="button"
    ...
    <View style={styles.voiceContainer}>
        ...
        {buttons.map((btn, i) => (
          <TouchableOpacity
            ...
            style={[
              ...
              btn.isActive && styles.voiceButtonActive,
            ]}
            onPress={btn.onPress}
            activeOpacity={0.8}
            accessible
          ...
          >
            ...
            <Text style={[styles.voiceLabel, btn.isActive && styles.voiceLabelActive]}>
              {btn.label}
            </Text>
          </TouchableOpacity>
        ))}
      ...
      {endCallButton && (
        <TouchableOpacity
          style={[
            styles.voiceEndCall,
            { width: endCallSize, height: endCallSize, borderRadius: endCallSize / 2 },
          ]}
          onPress={endCallButton.onPress}
          activeOpacity={0.8}
          accessible
