...
export const CompatibilityScore: React.FC<CompatibilityScoreProps> = ({ score, size = 'small' }) => {
  const color = getScoreColor(score);
  const isLarge = size === 'large';

  return (
    <View style={[styles.container, isLarge && styles.containerLarge]} accessible accessibilityLabel={`${score}% compatible`}>
